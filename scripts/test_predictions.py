...
sys.path.insert(0, '/Users/robertorossa/Desktop/Unicaba/Tercer cuatrimestre/Programacion de vanguardia/Python/TP_Prog_Vanguardia')
...
def main():
    ...
    try:
        ...
        print(f"📈 Total reservas históricas: {result['metadata']['total_reservas_historicas']}")
        ...
        for pred in result['predicciones']:
            ...
            print(f"  {emoji} {pred['dia_semana']} {pred['fecha']}: "
        ...
        for dia, horarios in result['horarios_pico'].items():
            if horarios:
                ...
                for hora in horarios[:3]:  # Top 3
                    print(f"    └─ {hora['hora']}: {hora['reservas']} reservas "
        ...
        if result['anomalias']:
            ...
            for anomalia in result['anomalias'][:5]:  # Mostrar max 5
                ...
                print(f"  {emoji} {anomalia['fecha']}: {anomalia['reservas']} reservas "
        ...
        for rec in result['recomendaciones']:
            ...
            print(f"  {estado_emoji} {rec['dia_semana']} {rec['fecha']}: "
