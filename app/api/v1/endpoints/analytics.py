        ...
        for i in range(min(days, 30), -1, -1):
            ...
            for r in reservas:
                ...
                fecha_reserva = r.fecha_hora_inicio.replace(
                    tzinfo=ZoneInfo("America/Argentina/Buenos_Aires")) if r.fecha_hora_inicio.tzinfo is None else r.fecha_hora_inicio
...
def get_prediccion_ocupacion(
    ...
    try:
        ...
        raise HTTPException(status_code=500,
                            detail=f"Error al generar predicciones: {str(e)}") from e
...
def get_inventario_metrics(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
                detail=f"Error al obtener métricas de inventario: {str(e)}") from e
...
def get_weekly_demand_predictions(
    ...
    try:
        ...
        metadata_transformada = {
            ...
            "confianza_promedio": sum(p["confianza"] for p in resultado.get(
