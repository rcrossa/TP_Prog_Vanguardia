...
class Reserva(Base):
    ...
    id_articulo: Mapped[Optional[int]] = mapped_column(Integer, ForeignKey("articulos.id"), nullable=True)
    id_sala: Mapped[Optional[int]] = mapped_column(Integer, ForeignKey("salas.id"), nullable=True)
    id_persona: Mapped[int] = mapped_column(Integer, ForeignKey("personas.id"), nullable=False)
