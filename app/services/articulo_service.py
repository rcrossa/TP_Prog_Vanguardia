...
class ArticuloService:
    ...
    def get_articulos(db: Session, skip: int = 0, limit: int = 100, 
                     disponible: Optional[bool] = None) -> List[Articulo]:
        """
    ...
    @staticmethod
    def get_articulos_disponibles(db: Session, skip: int = 0, limit: int = 100) -> List[Articulo]:
        """
    ...
    @staticmethod
    def update_articulo(db: Session, articulo_id: int, articulo_data: ArticuloUpdate) -> Optional[Articulo]:
        """
